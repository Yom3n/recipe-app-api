...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_recipies_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user('asd@gmail.com', '123123')
    ...
    def test_partial_update_recipe(self):
        """Test updateing a recipe with patch"""
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_ingredients(self):
        """Test returning recipe with specyfic ingredients"""
        recipe1 = sample_recipe(user=self.user, title='Posh beans on toast')
        recipe2 = sample_recipe(user=self.user, title='Chicken cacciatore')
        ingredient1 = sample_ingredient(user=self.user, name='Feta chees')
